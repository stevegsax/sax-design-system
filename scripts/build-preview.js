...
const outDir = path.join(ROOT, 'dist', 'catalog');
mkdirSync(outDir, { recursive: true });

const sampleHref = (s) => (s === 'presentation' ? '../presentation/presentation.html' : `../samples/${s}.html`);
...
${navStrip({
    ...
    links: [
      ...
      { label: 'sample →', href: sampleHref(situation) },
    ],
  })}
...
`;
  ...
  console.log(`dist/catalog/${situation}.html`);
}
